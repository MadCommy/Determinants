...
\begin{frame}{Is there always an LU decomposition?}
    ...
    An LU decomposition of $A$ exists if and only if each of its leading principle minors
    ...
    % TODO: give more distinction between LU and PLU factorization
    % Jumped into PLU without defining what it is and how it is distinct from LU
