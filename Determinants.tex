...
\begin{frame}{Big-O notation}
    ...
    \begin{block}{Definition}
        A function $f$ is defined to be $\mathcal{O}(g)$, with $g$ a function iff
        \[
...
\begin{frame}{How do we find the PLU decomposition? (cont.)}
    ...
    \[
        ...
        \text{det}\begin{pmatrix}{}
            ...
            4 & 3 & 3 \\
            8 & 7 & 9
        \end{pmatrix}=\text{sgn}(\sigma_P) \cdot \left( \prod_{i=1}^{n} l_{i,i} \right) \cdot
        \left( \prod_{i=1}^{n} u_{i,i} \right)
    \]
    \[
        =-1\cdot8\cdot-\frac{1}{2}=4.
    \]
